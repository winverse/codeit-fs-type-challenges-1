...
export type FeaturedProduct = ClothingProduct | ShoeProduct;
export type ClothingSizeOption = 'S' | 'M' | 'L' | 'XL';
...
export type Benefit = DiscountCoupon | GiftCard;
export type BenefitState = 'ready' | 'active' | 'expired';
